...
use crate::angular::{ModuleMeta, NgTraitHandler};

pub struct NgModuleHandler;

impl NgTraitHandler<ModuleMeta> for NgModuleHandler {
    fn parse(&self, _node: &Vec<ExprOrSpread>) -> Result<ModuleMeta, String> {
    ...
    fn transform_to_ivy(&self, meta: &ModuleMeta, class: &mut Class) -> Result<(), String> {
    ...
    fn transform_to_jit(&self, meta: &ModuleMeta, class: &mut Class) -> Result<(), String> {
