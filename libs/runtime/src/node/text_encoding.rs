//! TextEncoder / TextDecoder (WHATWG encoding). Surfaced as eager globals; this module backs them and any explicit import.
//!
//! Lazy: built only on first `require`/`import` of `node:text_encoding` (unless surfaced as a global by
