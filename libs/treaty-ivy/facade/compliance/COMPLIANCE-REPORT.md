...
Generated by `libs/treaty-ivy/facade/compliance/run-compliance.mjs` on 2026-06-04.
...
| Metric | Value |
| --- | --- |
| Total compliance cases | 643 |
| Compiled (runnable) | 186 |
| PASS | 186 |
| DIFF | 0 |
| Skipped (un-runnable) | 457 |
| **Pass-rate (of runnable subset)** | **100.0%** (186/186) |
| Pass-rate (of full corpus) | 28.9% (186/643) |
...
186 runnable compliance cases match Angular's golden `ɵɵdefineComponent` block:
...
- r3_view_compiler_template/should drop HTML comments and emit no comment instruction
